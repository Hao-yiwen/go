...
// The Universe scope 包含 all predeclared objects of Go.
// It 是 outermost scope of any chain of nested scopes.
var Universe *Scope

// The Unsafe package 是 package returned by an importer
...
// Typ 包含the predeclared *Basic types indexed by their
...
func defPredeclaredTypes() {
	...
	// consistently use the Alias node), we 应该是 able to clarify user facing
	...
	// interface.
	{
		...
		// It shouldn't matter which representation of any 是一个ctually inserted
...
// 一个builtinId 是 id of a builtin function.
type builtinId int
...
// DefPredeclaredTestFuncs 定义the assert and trace built-ins.
