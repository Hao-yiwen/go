...
func (s *gcSizes) Sizeof(T Type) int64 {
	...
	case *Array:
		...
		// esize > 0
		// Final size is esize * n; and size 必须是 <= maxInt64.
...
// gcSizesFor 返回the Sizes used by gc for an architecture.
// The result 是一个 nil *gcSizes pointer (which is not a valid types.Sizes)
