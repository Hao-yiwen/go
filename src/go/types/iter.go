...
// This file 定义 go1.23 iterator methods for a variety of data
...
// Methods 返回a go1.23 iterator over all the methods of an
...
// ExplicitMethods 返回a go1.23 iterator over the explicit methods of
...
// EmbeddedTypes 返回a go1.23 iterator over the types embedded within an interface.
//
...
// Methods 返回a go1.23 iterator over the declared methods of a named type.
//
// Example: for m := range t.Methods() { ... }
...
// Children 返回a go1.23 iterator over the child scopes nested within scope s.
//
...
// Fields 返回a go1.23 iterator over the fields of a struct type.
//
...
// Variables 返回a go1.23 iterator over the variables of a tuple type.
//
...
// Methods 返回a go1.23 iterator over the methods of a method set.
//
...
// Terms 返回a go1.23 iterator over the terms of a union.
//
...
// TypeParams 返回a go1.23 iterator over a list 类型为 parameters.
//
...
// Types 返回a go1.23 iterator over the elements of a list of types.
//
