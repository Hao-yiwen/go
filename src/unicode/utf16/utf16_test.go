...
var surrogateTests = []struct {
	...
	{'\u007A', false},     // 拉丁小写字母 Z
	{'\u6C34', false},     // CJK 统一表意文字-6C34（水）
	{'\uFEFF', false},     // 字节顺序标记
	{'\U00010000', false}, // LINEAR B 音节 B008 A（第一个非 BMP 码点）
	{'\U0001D11E', false}, // 音乐符号 G 谱号
	{'\U0010FFFD', false}, // 私人使用字符-10FFFD（最后一个 Unicode 码点）
